...
type Transaction struct {
	...
	UserID       uint            `gorm:"not null;index:idx_user_type;index:idx_transactions_user_created" json:"user_id"`
	...
	CreatedAt    time.Time       `gorm:"index:idx_transactions_user_created" json:"created_at"`
